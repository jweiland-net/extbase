...
interface Tx_Extbase_Persistence_ManagerInterface {
	 ...
	 * @throws Tx_Extbase_Persistence_Exception_UnknownObjectException if the given object is not known to the Persistence Manager
	 * @api
	 */
	 ...
	 * @throws Tx_Extbase_Persistence_Exception_UnknownObjectException if array contains objects that are not known to the Persistence Manager
	 * @api
