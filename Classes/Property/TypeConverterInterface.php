...
interface Tx_Extbase_Property_TypeConverterInterface {
	 ...
	 * - An instance of Tx_Extbase_Error_Error -- This will be a user-visible error message later on.
	 ...
	 * @param Tx_Extbase_Property_PropertyMappingConfigurationInterface $configuration
	 * @return mixed|Tx_Extbase_Error_Error the target type, or an error object if a user-error occurred
	 * @throws Tx_Extbase_Property_Exception_TypeConverterException thrown in case a developer error occurred
	 * @api
	 */
