 ...
 */
abstract class Tx_Extbase_Messaging_AbstractStandaloneMessage extends Tx_Extbase_Messaging_AbstractMessage {
	 ...
	 */
	public function __construct($message = '', $title = '', $severity = Tx_Extbase_Messaging_AbstractMessage::ERROR) {
		if (!empty($message)) {
