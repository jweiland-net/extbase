 ...
 */
class Tx_Extbase_Messaging_FlashMessageService implements t3lib_Singleton {

	/**
	 * Array of Tx_Extbase_Messaging_FlashMessageQueue objects
	 *
	 * @var array
	 */
	...
	public function getMessageQueueByIdentifier($identifier = 'core.template.flashMessages') {
		if (!isset($this->flashMessageQueues[$identifier])) {
			$this->flashMessageQueues[$identifier] = t3lib_div::makeInstance(
				'Tx_Extbase_Messaging_FlashMessageQueue',
				$identifier
			);
		}
