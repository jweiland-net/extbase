 ...
 * @api
 */
class Tx_Extbase_Validation_Validator_CollectionValidator extends Tx_Extbase_Validation_Validator_GenericObjectValidator {
	...
	public function validate($value) {
		...
		if ($this->acceptsEmptyValues === FALSE || $this->isEmpty($value) === FALSE) {
			if ((is_object($value) && !Tx_Extbase_Utility_TypeHandlingUtility::isCollectionType(get_class($value))) && !is_array($value)) {
	...
	public function isValid($value) {
		...
		foreach ($value as $index => $collectionElement) {
			...
			if ($collectionElementValidator instanceof Tx_Extbase_Validation_Validator_ObjectValidatorInterface) {
